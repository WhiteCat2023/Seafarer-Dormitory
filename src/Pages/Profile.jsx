...
export default function Profile() {
  ...
  return (
    <div className="container mx-auto sm:py-10 sm:px-4 h-full mb-10">
      ...
      {/* Profile Section */}
      <div className="h-full border-2 border-blue-500 col-span-6 rounded-xl pl-16 pt-8 max-w-full flex flex-col">
        ...
        {/* Log Out Button */}
        <div className="mt-auto pt-10 mb-7">
          <button
...
>>>>>>> e8ed8b6944dc6715fcf9c84b72ca27e486d5b74c
}
