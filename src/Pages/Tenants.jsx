            ...
            <div className="container mx-auto mt-10 h-5/6">
                <div className="flex items-center justify-between mb-5">
                    <nav className="flex items-center">
                        <h1 className="text-5xl font-outfit font-semibold">Tenants</h1>
                        <button data-modal-target="crud-modal" data-modal-toggle="crud-modal" className="bg-purple px-3 py-2 rounded-xl text-white ms-4 hover:bg-transparent hover:border-2 hover:border-blue-500 hover:text-blue-500 border-2 border-transparent">New Tenants</button>
                    </nav>
