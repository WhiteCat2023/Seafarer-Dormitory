...
export default function EditApartments({isOpen, onClose, key}){

    const [inputs, setInputs] = useState({apartmentName: '', numberOfRooms: 0, location: '', description: '', action: '', key: key});
    ...
    const handleAddNewApartment = (event) => {
        ...
        setInputs({action: event.target.name});
        console.log(inputs)
        axios.post('https://seafarerdorm.scarlet2.io/Apartments/apartments.php', inputs).then((response) => {
