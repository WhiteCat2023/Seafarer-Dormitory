                                            ...
                                            <div className='flex gap-5 flex-col lg:flex-row overflow-auto'>
                                                <div className="grid gap-4 mb-4 grid-cols-2 lg:w-2/4">
                                                    <div className="col-span-2">
                                                        ...
                                                        <input onChange={handleChange} type="text" name="apartmentName" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 " placeholder={item.apartment_name} required=""/>
                                                    </div>
                                                    <div className="col-span-2">
                                                        <label className="block mb-2 text-sm font-medium text-gray-900 text-start">Number of rooms #</label>
                                                        <input onChange={handleChange} type="number" name="numberOfRooms" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 " placeholder={item.number_of_rooms} required=""/>
                                                    </div>
                                                    <div className="col-span-2">
                                                        <label className="block mb-2 text-sm font-medium text-gray-900 text-start">Location</label>
                                                        <input onChange={handleChange} type="text" name="location" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 " placeholder={item.location} required=""/>
                                                    </div>
                                                    <div className="col-span-2">
                                                        <label className="block mb-2 text-sm font-medium text-gray-900 text-start">Availability</label>
                                                        <select onChange={handleChange} type="text" name="availability" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 " placeholder="Type location" required="">
                                                    ...
                                                    <div className='col-span-2 flex'>
                                                        <div className="flex-grow-1 me-4">
                                                            ...
                                                            <input onChange={handleChange} type="number" name="price" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 " placeholder={item.price} required=""/>
                                                        </div>
